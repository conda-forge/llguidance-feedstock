...
pixi global install llguidance
```
...
It is possible to list all of the versions of `llguidance` available on your platform:
...
```
pixi search llguidance --channel conda-forge
```
